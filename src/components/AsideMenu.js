        ...
        <aside className="container mx-auto">
          <div className="flex flex-wrap justify-center -mx-4">
            ...
            <div className="w-full px-4 mb-4 md:w-3/12 md:mb-0">
              <h5 className="relative mb-2 text-lg font-semibold">Special Letter</h5>
              <form action="/">
                <label className="relative w-full">
                  <input type="text" className="w-full px-5 py-3 bg-gray-100 rounded-xl focus:outline-none" placeholder="Your email adress" />
